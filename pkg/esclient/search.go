...
func SearchMatchPhrasePerfix[T any](ctx context.Context, transport esapi.Transport, request SearchMatchPerfixRequest) (*SearchListResponse[T], error) {
	...
	searchQuery["query"] = map[string]any{
		"bool": map[string]any{
			"must": map[string]any{
				"match_phrase_perfix": matchPrefix,
			},
		},
	}
