...
type Logger interface {
	...
	GrpcClientInterceptorLoggerErr(method string, req interface{}, reply interface{}, time time.Duration, metaData map[string][]string, err error)
...
// Debug uses fmt.Sprint to constuct and log a message.
...
// Info uses fmt.Sprint to constuct and log a message
...
// Printf use fmt.Sprintf to log a templated message
...
// Sync flushes any bufferd log entries
